...
static EventState ClipboardGlobalHotkeys(int hotkey)
{
...
static Hotkey clipboard_hotkeys[] = {
	Hotkey(_clipboard_copy_hotkeys,  "copy",            WID_CT_COPY),
	Hotkey(_clipboard_paste_hotkeys, "paste",           WID_CT_PASTE),
	Hotkey('1',                      "rail",            WID_CT_WITH_RAIL),
	Hotkey('2',                      "road",            WID_CT_WITH_ROAD),
	Hotkey('4',                      "water",           WID_CT_WITH_WATER),
	Hotkey('5',                      "air",             WID_CT_WITH_AIR),
	Hotkey('6',                      "terrain",         WID_CT_TERRAFORM),
	Hotkey('7',                      "convert_rail",    WID_CT_CONVERT_RAILTYPE),
	Hotkey('8',                      "mirror_signals",  WID_CT_MIRROR_SIGNALS),
	Hotkey('9',                      "upgrade_bridges", WID_CT_UPGRADE_BRIDGES),
	Hotkey(WKC_CTRL | ',',           "rotate_l",        WID_CT_ROTATE_LEFT),
	Hotkey(WKC_CTRL | '.',           "rotate_r",        WID_CT_ROTATE_RIGHT),
	Hotkey(WKC_CTRL | '\\',          "reflect_ne_sw",   WID_CT_REFLECT_NE_SW),
	Hotkey(WKC_CTRL | '/',           "reflect_nw_se",   WID_CT_REFLECT_NW_SE),
	HOTKEY_LIST_END
};
HotkeyList ClipboardToolbarWindow::hotkeys("clipboard", clipboard_hotkeys, ClipboardGlobalHotkeys);
...
static const NWidgetPart _nested_clipboard_toolbar_widgets[] = {
	...
	NWidget(NWID_HORIZONTAL),
		...
		NWidget(WWT_PANEL, COLOUR_DARK_GREEN), SetMinimalSize(0, 22),
			NWidget(NWID_HORIZONTAL),
				NWidget(WWT_TEXT, COLOUR_DARK_GREEN, WID_CT_HEIGHT_DIFF_GLYPH), SetDataTip(STR_EMPTY, STR_EMPTY), SetFill(0, 1),
				NWidget(WWT_TEXT, COLOUR_DARK_GREEN, WID_CT_HEIGHT_DIFF), SetDataTip(STR_CLIPBOARD_HEIGHT_DIFF, STR_EMPTY), SetFill(0, 1),
				NWidget(NWID_VERTICAL), SetPIP(3, 0, 3),
					NWidget(NWID_HORIZONTAL), SetPIP(0, 1, 3),
						NWidget(WWT_PUSHIMGBTN, COLOUR_GREY, WID_CT_HEIGHT_DIFF_INCREASE), SetDataTip(SPR_ARROW_UP, STR_EMPTY), SetFill(0, 1),
						NWidget(WWT_PUSHIMGBTN, COLOUR_GREY, WID_CT_HEIGHT_DIFF_DECREASE), SetDataTip(SPR_ARROW_DOWN, STR_EMPTY), SetFill(0, 1),
					EndContainer(),
				EndContainer(),
			EndContainer(),
		EndContainer(),
