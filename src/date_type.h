 ...
 */
#define DAY_TICKS (ORIG_DAY_TICKS * _settings_game.economy.daylength_factor)
...
#define TOWN_GROWTH_TICKS (70 * _settings_game.economy.daylength_factor)  ///< cycle duration for towns trying to grow. (this originates from the size of the town array in TTD
