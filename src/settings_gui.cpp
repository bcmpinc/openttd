...
static SettingEntry _settings_ui_display[] = {
	...
	SettingEntry("gui.smallmap_grid_size"),
	SettingEntry("gui.smallmap_gridline_contrast"),
	SettingEntry("gui.smallmap_gridline_thickness"),
...
static SettingEntry _settings_vehicles_trains[] = {
	...
	SettingEntry("vehicle.atc_speed_adaption"),
